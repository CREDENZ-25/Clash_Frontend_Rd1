...
const Login=()=>{
    return(
      ...
      <div  className="home-container h-screen w-screen bg-cover bg-center flex flex-col
...
>
  ...
  >
    ...
    <br />
    <form className="flex flex-col bg--600 items-center pt-8 font-['Pixelify_Sans',serif] font-bold  ">
      <div className='form-inputs mb-[30px] bg--600 h-[30vh] flex flex-col justify-center items-center ' >
        ...
        <div className="form-group mb-2 text-left bg--500">
            <label for="username" className="block mb-1"><svg
...
>
  ...
  >
    USERNAME
        ...
        <div className="form-group mb-2 text-left bg--500">
            <label for="password" className="block mb-1"><svg
  viewBox="0 0 500 100"
  xmlns="http://www.w3.org/2000/svg"
  className="w-full h-full"
>
  ...
  >
    PASSWORD
       ...
       <Button bg="#DE5027"
            className="w-45 h-10 hover:bg-[#b84716]"
             >
                              <svg
                      viewBox="0 0 289 50"
                      xmlns="http://www.w3.org/2000/svg"
